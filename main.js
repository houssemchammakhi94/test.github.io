...
/* harmony import */ var rxjs_add_operator_retry__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/add/operator/retry */ "./node_modules/rxjs/_esm5/add/operator/retry.js");
...
var ApiService = /** @class */ (function () {
    function ApiService(http) {
        this.http = http;
        this.url = 'https://api.producthunt.com/v1/posts/all?sort_by=votes_count&order=desc&search[featured_day]=5&search[featured_month]=5&search[featured_year]=2019';
        this.url2 = 'https://api.producthunt.com/v1/posts/all?sort_by=votes_count&order=desc&search[featured_day]=5&search[featured_month]=5&search[featured_year]=2019';
        this.token = '';
    }
    ApiService.prototype.getData = function () {
        ...
        return this.http.get(this.url, {
            headers: {
                "Authorization": ["Bearer 0O9w1USQlqkrklw4yeUXGWkVV_g36lFuqCbi0qP4KtE"]
            }
        });
    };
    ApiService.prototype.getOtherData = function () {
        return this.http.get(this.url, {
            headers: {
                "Authorization": ["Bearer 0O9w1USQlqkrklw4yeUXGWkVV_g36lFuqCbi0qP4KtE"]
            }
...
module.exports = "p {\n  font-family: Lato;\n}\n\nbutton.button {\n    background: transparent;\n    border: 2px solid #000;\n    padding: 10px;\n    font-weight: bold;\n    cursor: pointer;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<hello name=\"{{ name }}\"></hello>\n<p>\n  Click the button to get a new Chuck Norris joke :)\n</p>\n\n<hr />\n\n<button class=\"button\" (click)=\"getJoke()\">Show me Another</button>\n\n\n\n<p *ngFor=\"let post of posts\">{{ post.name }}</p>\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(api) {
        this.api = api;
        this.name = 'Angular 5 HTTP Example';
    }
    AppComponent.prototype.ngOnInit = function () {
        this.getJoke();
    };
    AppComponent.prototype.getJoke = function () {
        var _this = this;
        this.api.getData()
            .subscribe(function (data) { return _this.posts = data.posts; });
...
module.exports = __webpack_require__(/*! C:\Users\Asus\Downloads\angular5-http-example\src\main.ts */"./src/main.ts");
